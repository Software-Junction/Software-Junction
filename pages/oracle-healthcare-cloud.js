...
import Oraclehealth from '../src/components/hospital-management-software/oracle-healthcare-cloud/index'
const oraclehealthcarecloud = () => {
    let schemaData = {
...
export default oraclehealthcarecloud
