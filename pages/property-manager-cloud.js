...
import PropertyManagementCloud from '../src/components/property-management-software/property-manager-cloud/index'
const propertymanagementcloud = () => {
    let schemaData = {
  ...
  return (
    <>
      ...
      <PropertyManagementCloud/>
    </>
  )
}

export default propertymanagementcloud
