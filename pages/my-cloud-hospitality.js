...
import MyCloudHospitality from '../src/components/property-management-software/my-cloud-hospitality/index'
const mycloudhospitalit = () => {
    let schemaData = {
...
export default mycloudhospitalit
