...
import styles from "../taskworld/taskworld.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Taskworld</h3>
                    <h5 className="text-light">Work Smarter Together </h5>
