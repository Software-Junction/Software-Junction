  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Tiemchart Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
              ...
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5>Monthly, Onetime(Perpetual license)</h5>
                  </Col>
                  <Col lg={3} className="mb-3">
                    <h5>Accessibility :</h5>
                  </Col>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        Waterdreef 314 3824 HD Amersfoort The Netherlands{" "}
                      </p>
                    </h5>
                  </Col>
                </Row>
