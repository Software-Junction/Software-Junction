...
import styles from "../geniebooks/gen.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">GenieBooks</h3>
                    <h5 className="text-light">
                      Easy to use account software for small business
                    </h5>
