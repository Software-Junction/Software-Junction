                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Dandelion Technologies Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      18 FLOOR-3, PLOT14 LALWANI INDUSTRIAL, ESTATE, G.D. AMBEKAR MARG WADALA, MUMBAI, Mumbai City, Maharashtra, India, 40003
                      </p>
                    </h5>
                  </Col>
                </Row>
