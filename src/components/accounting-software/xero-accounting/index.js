...
import styles from "../xero-accounting/xero.module.scss";
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/accounting-software">Accounting Software</Link>
                  </li>
                  &nbsp;
                  <span style={{ color: "#f95738 " }}>
                    <MdKeyboardDoubleArrowRight />
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Xero Accounting</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Xero Accounting</h3>
                    <h5 className="text-light">Software by Xero Limited</h5>
