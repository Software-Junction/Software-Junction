                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Horizon Technology Solutions
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Horizon Technology Solutions Door No. 55/2885,1st Floor of 'MIDHILA', Cheruparampath 1st Cross Rd., Kadavanthra, Cochin India
                      </p>
                    </h5>
                  </Col>
                </Row>
