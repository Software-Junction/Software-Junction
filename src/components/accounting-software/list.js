...
<Form.Group
  ...
  >
              ...
              >
                <div className="d-flex p-4">
                  ...
                  <div>
                    <Link href="/deskera">
                      {" "}
                      <h5>Deskera</h5>
                      <p>Best Accounting Software for Small Businesses</p>
                    </Link>
                    <div className="d-flex">
                      <div className="me-3">
                        <Link href="/deskera">
                ...
                <p className="px-4">
                  Introducing Deskera's Accounting Software, a powerful
                  financial management solution designed to streamline your
                  business's financial operations. With its user-friendly
                  interface and robust features, you can easily manage your
                  accounting tasks, from invoicing and expense tracking to
                  payroll and financial reporting. Deskera's cloud-based
                  platform ensures real-time collaboration and data
                  accessibility, enabling you to make informed financial
                  decisions anytime, anywhere. Say goodbye to manual bookkeeping
                  and embrace efficiency with Deskera Accounting Software.
              ...
              {isShowMore && (
                <>
                  ...
                  >
                    <div className="d-flex p-4">
                      ...
                      <div>
                        <Link href="/acmeinsight">
                          {" "}
                          <h5> AcmeInsight </h5>
                          <p>Billing, accounting and inventory software</p>
                        </Link>
                        <div className="d-flex">
                          <div className="me-3">
                            <Link href="/acmeinsight">
                    ...
                    <p className="px-4">
                      AcmeInsight: Revolutionize your business with our
                      cutting-edge software. AcmeInsight is a powerful,
                      user-friendly platform designed to streamline operations
                      and boost efficiency. Whether you're in retail,
                      hospitality, or any other industry, our software offers a
                      range of features to optimize inventory management, sales
                      tracking, and customer engagement. With AcmeInsight, you
                      can make data-driven decisions, enhance customer
                      experiences, and propel your business to new heights.
