...
import EnthuP from "../call-center-software/enthu/price";

import CloudTalkF from "../call-center-software/cloudtalk/features";
import CloudTalkU from "../call-center-software/cloudtalk/usp";
import CloudTalkP from "../call-center-software/cloudtalk/price";

import ServetelF from "../call-center-software/servetel/features";
import ServetelU from "../call-center-software/servetel/usp";

import AavazF from "../call-center-software/aavaz/features";
import AavazU from "../call-center-software/aavaz/usp";

import FreshcallerF from "../call-center-software/freshcaller/features";
import FreshcallerU from "../call-center-software/freshcaller/usp";
import FreshcallerP from "../call-center-software/freshcaller/price";

import AmeyoF from "../call-center-software/ameyo/features";
import AmeyoU from "../call-center-software/ameyo/usp";

import ZohoF from "../call-center-software/zoho-desk/features";
import ZohoU from "../call-center-software/zoho-desk/usp";
import ZohoP from "../call-center-software/zoho-desk/price";

import Dialer360F from "../call-center-software/dialer360/features";
import Dialer360U from "../call-center-software/dialer360/usp";
import Dialer360P from "../call-center-software/dialer360/price";

import KnowlarityF from "../call-center-software/knowlarity/features";
import KnowlarityU from "../call-center-software/knowlarity/usp";
import KnowlarityP from "../call-center-software/knowlarity/price";

import ExotelF from "../call-center-software/exotel/features";
import ExotelU from "../call-center-software/exotel/usp";
import ExotelP from "../call-center-software/exotel/price";
                ...
                <Table responsive bordered className={`${styles["thead"]}`}>
                  <thead className={styles["heading-stick"]}>
                    <tr>
                      ...
                      <th className={styles["heading-link"]}><Link href='/enthu'>Enthu</Link></th>
                      <th className={styles["heading-link"]}><Link href='/cloudtalk'>CloudTalk</Link></th>
                      <th className={styles["heading-link"]}><Link href='/servetel'>Servetel</Link></th>
                      <th className={styles["heading-link"]}><Link href='/aavaz'>Aavaz</Link></th>
                      <th className={styles["heading-link"]}><Link href='/freshcaller'>Freshcaller</Link></th>
                      <th className={styles["heading-link"]}><Link href='/ameyo'>Ameyo</Link></th>
                      <th className={styles["heading-link"]}><Link href='/zoho-desk'>Zoho Desk</Link></th>
                      <th className={styles["heading-link"]}><Link href='/dialer360'>Dialer360</Link></th>
                      <th className={styles["heading-link"]}><Link href='/knowlarity'>Knowlarity</Link></th>
                      <th className={styles["tbl-hd1"]}><Link href='/exotel'>Exotel</Link> </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Unifying Marketing, Sales, and Support Teams</p>
                          <p>
                            Breaking Down Barriers to Multi-channel
                            Conversations
                          </p>
                          <p>Creating Fluid and Engaging Experiences</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "9px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Intuitive and Scalable</p>
                          <p>
                            Better Together with Freshdesk and Freshworks Neo
                          </p>
                          <p>Omnichannel Service</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "9px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Video Chat Integration</p>
                          <p>Truecaller Verified ID Integration</p>
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Empowered Agents</p>
                          <p>Customer Testimonials</p>
                          <p>Extensive Integrations</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "9px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Fastest Dialing</p>
                          <p>100% Data Protection</p>
                          <p>Higher Contact Rate</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "9px" }}
