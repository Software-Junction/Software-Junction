...
import styles from "../hoduCC/hoduCC.module.scss";
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">HoduCC</h3>
                    <h5 className="text-light">
                      Redefine Communication with Best Call Center Software
                    </h5>
