  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">HoduCC Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        1403/04, Shilp Epitome, near Infostretch., behind
                        Rajpath Rangoli Road, Ahmedabad, Gujarat 380054
                      </p>
                    </h5>
                  </Col>
                </Row>
