...
import styles from "../ticket-tailor/tic.module.scss";
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/event-management-software">
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Ticket Tailor</h3>
                    <h5 className="text-light">Software by Ticket Tailor</h5>
