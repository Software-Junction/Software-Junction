...
import styles from "../eventavenue/ave.module.scss";
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">EventAvenue</h3>
                    <h5 className="text-light">Software by Event avenue</h5>
