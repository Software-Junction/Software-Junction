  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">TYASuite's Inventory Management Software User Reviews</h3>
          </Col>
          <Col lg={10}>
            <div
            ...
            >
              <Row>
                <Col lg={3}>
                  ...
                  <p>
                    Education Management, 201-500 employees Used daily for more
                    than 2 years
                  </p>
                ...
                <Col lg={9}>
                  ...
                  <p>
                    ...
                    split job of teaching Spanish and EL. I could easily see my
                    Spanish students' progress and didn't have to worry about
                    trying to add scores to PowerSchool since it automatically
                    synced. I could also see every class my EL students had and
                    could see what they needed to complete or needed extra
                    support with.
                  </p>
                  <h5 className="mt-4">
                    Pros{" "}
                  ...
                  <p>
                    ...
                    graded. My favorite feature of all was that it automatically
                    integrated and synced with PowerSchool.
                  </p>
                  <h5>
                    Cons{" "}
                    <span style={{ color: "#f95738 " }}>
        ...
        <Row>
          <Col lg={12}>
            <div
              className={`${styles["row-mob"]} box bg-light mt-4 border  rounded-4 p-4`}
            >
              <Row>
                <Col lg={3}>
                  <Image
