  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">TYASuite's Inventory Management Software Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : TYASuite Software Solutions Private Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      R.K Complex, 2nd Floor No.152 K.H.B Colony , 5th Block, Koramangala
                      </p>
                    </h5>
                  </Col>
                </Row>
