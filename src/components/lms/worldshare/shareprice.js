      ...
      <Container>
        <Row>
            ...
            <Col lg={3} className='mb-3'>
                <div className={`${styles['shr-price-box']} box  bg-light border h-100 rounded-4 p-4`}>
                    ...
                    <div className='text-center'>
                    <Button variant='primary' size='sm' className={styles['shr-price-btn']}>Free Trail</Button>
                    </div>
                </div>
            </Col>
            <Col lg={3} className='mb-3'>
                <div className={`${styles['shr-price-box']} box  bg-light border h-100  rounded-4 p-4`}>
                    ...
                    <div className='text-center'>
                    <Button variant='primary' size='sm' className={styles['shr-price-btn1']}>Free Trail</Button>
                    </div>
                </div>
            </Col>
            <Col lg={3} className='mb-3'>
