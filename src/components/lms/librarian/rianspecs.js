      ...
      <Container>
        <Row>
          ...
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["ria-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["ria-spec-mob"]} d-flex`}>
                    
                    <h5 className="me-3">
                        <span className={styles["ria-icon-clr"]}>
                          <FaGlobe />
                        </span>{" "}
                        Web App
                      </h5>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : CR2 Technologies Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["ria-icon-clr"]}>
                        <BsBuildingsFill />
