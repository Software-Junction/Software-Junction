      ...
      <Container>
        <Row>
          ...
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["alx-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["alx-spec-mob"]} d-flex`}>
                    
                    <h5 className="me-3">
                        <span className={styles["alx-icon-clr"]}>
                          <IoLogoWindows />
                        </span>{" "}
                        Windows
                      </h5>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      COMPanion Corporation LLC 1831 E Fort Union Blvd Salt Lake City, Utah USA
                      </p>
                    </h5>
                  </Col>
                </Row>
