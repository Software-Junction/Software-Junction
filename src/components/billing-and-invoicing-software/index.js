        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <p className="my-3">
                Best billing software options are TallyPrime, Zoho invoices,
                myBillBook, Vyapar, and MargERP. Such online billing software
                with GST simplifies and streamlines the business billing
                process.
              </p>
            </Col>
          </Row>
