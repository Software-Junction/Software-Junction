    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
              eRetail Cybertech - pranaPOS Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : eRetail Cybertech Pvt.Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        Shivams Tejas, Plot No 186 & 187,4th Floor, above
                        Ratnadeep Supermarket Vayupuri Secunderabad, Telangana
                      </p>
                    </h5>
                  </Col>
                </Row>
