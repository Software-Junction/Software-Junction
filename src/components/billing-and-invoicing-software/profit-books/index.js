...
import styles from "../profit-books/profit-books.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">ProfitBooks</h3>
                    <h5 className="text-light">
                      Best billing software in India for small business
                    </h5>
