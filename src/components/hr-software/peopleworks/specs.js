                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Crossdomain Solutions Pvt Ltd
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      2nd & 3rd Floor of Tejas Arcade, 527/B, 528/A, 529/A-9/, 1st Main Road Dr Rajkumar Rd Bengaluru Karnataka 560010
                      </p>
                    </h5>
                  </Col>
                </Row>
