        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <h3>Best HR Software for Your Business</h3>
              <p className="my-3">
                List of best HR software solutions are BambooHR, Zoho People,
                Wallet HR, Spine HR Suite, Keka, and Zenefits. These HR systems
                aid organizations in digitizing employee data and enhance
                collaboration between employees and HR managers.
              </p>
            </Col>
          </Row>
        </Container>
