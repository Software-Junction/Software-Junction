                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Nitso Technologies Pvt. Ltd
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                      </span>{" "}
                      Headquarter : Delhi, Greater Noida, Gurgaon, Gurugram, New Delhi, Noida
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <FaGlobe />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      A-602, Durga Colony, Jharsa Village, Sector 39, Gurugram, Haryana 122001
                      </p>
                    </h5>
                  </Col>
                </Row>
