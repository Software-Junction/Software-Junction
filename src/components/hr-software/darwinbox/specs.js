                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Darwinbox Digital Solutions Pvt. Ltd
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      3rd Floor, Skootr Forest, Block C, RMZ Futura Plot No. 14 and 15, Phase 2, HITEC City, Hyderabad, Telangana - 500081
                      </p>
                    </h5>
                  </Col>
                </Row>
