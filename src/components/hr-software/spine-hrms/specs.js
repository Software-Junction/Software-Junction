                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Spine Technologies India Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      407-408, 4th Floor, Ddefinity, Plot no 364, J.P.Road no. 1, Goregaon East, Mumbai- 400063
                      </p>
                    </h5>
                  </Col>
                </Row>
