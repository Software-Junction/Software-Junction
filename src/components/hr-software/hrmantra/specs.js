                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : HRMantra Software Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Kesar Residency, 65-70, Ground Floor, behind Bhagvati Hotel, Charkop Market, Kandivali West, Mumbai, Maharashtra 400067, India
                      </p>
                    </h5>
                  </Col>
                </Row>
