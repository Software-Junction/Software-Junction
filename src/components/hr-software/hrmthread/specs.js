                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Sensys Technologies Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Sensys Technologies Pvt Ltd 904, 905, 906, Corporate Annexe, Sonawala Road Goregaon (East), Mumbai India
                      </p>
                    </h5>
                  </Col>
                </Row>
