...
const featuresData = [
  ...
  { title: "Accounting" },{ title: "Academics " },{ title: "Curriculum Management" },
  { title: "Examination Management" },{ title: "Scheduling" },{ title: "Attendance management" },
  ...
  { title: "Faculty Management " },{ title: "User Customisation " },{ title: "Courses and Batches Management " },
  { title: "Staff Management " },{ title: "School District " },{ title: "Attendance Tracking " },
  { title: "Higher Education " },{ title: "Student Portal " },{ title: "Parent Portal " },
];

const Vclassfeatures = ({ styles }) => {
