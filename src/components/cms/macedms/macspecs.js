    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
              MAC EDMS Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["mac-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["mac-spec-mob"]} d-flex`}>
                      <h5 className="me-3">
                        <span className={styles["mac-icon-clr"]}>
                          <FaGlobe />
                        </span>{" "}
                        Web App
                      </h5>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Macademic Solutions
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["mac-icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      6th Floor, Swastik Square,Jawahar Cross road, Maninagar, Ahmedabad - 380008
                      </p>
                    </h5>
                  </Col>
                </Row>
