...
const Liteprice = ({styles}) => {
  return (
    <>
      <Container>
        <Row>
            <Col lg={12}>
                <h3 className='mb-3'>Iolite School Management Software Pricing</h3>
            </Col>
            <Col lg={3} className='mb-3'>
                <div className={`${styles['lite-price-box']} box  bg-light border h-100 rounded-4 p-4`}>
