...
const Campprice = ({styles}) => {
  return (
    <>
      <Container>
        <Row>
            <Col lg={12}>
                <h3 className='mb-3'>CampSteer Pricing</h3>
            </Col>
            <Col lg={3} className='mb-3'>
                <div className={`${styles['cam-price-box']} box  bg-light border h-100 rounded-4 p-4`}>
