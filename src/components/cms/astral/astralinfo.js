      ...
      <Container>
        <Row>
          <Col lg={6}>
            ...
            <div
              className={`${styles["ast-priceplan-box"]} box bg-light  rounded-4 p-3 mb-4 border`}
            >
              <h5>Pricing Plans :</h5>
              <p>
