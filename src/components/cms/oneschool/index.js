...
const Index = () => {
  return (
    <>
       <section className={styles["ons-heading"]}>
        <Container>
          <Row>
            <Col lg={12}>
            <div className={`${styles['ons-breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#f95738 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">OneSchool</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  <Image
                    ...
                    width="150"
                    height="10"
                    className={`${styles["ons-box-img"]} border bg-light p-4 rounded-3 shadow me-4`}
                  />
                  <div>
                    <h3 className="text-light">OneSchool</h3>
                    <h5 className="text-light">One School is a multipurpose system used by educat</h5>
      ...
      <section className={`${styles['ons-detail-bg']} pb-5`}>
        <Onedetails styles={styles}/>
      </section>
    </>
  )
}
