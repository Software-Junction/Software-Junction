      ...
      <Container>
        <Row>
          ...
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["flx-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["flx-spec-mob"]} d-flex`}>
                    <h5 className="me-3">
                        <span className={styles["flx-icon-clr"]}>
                          <FaGlobe />
                        </span>{" "}
                        Web App
                      </h5>
