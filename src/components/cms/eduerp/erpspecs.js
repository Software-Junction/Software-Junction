    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
              eduERP Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["erp-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["erp-spec-mob"]} d-flex`}>
                      <h5 className="me-3">
                        <span className={styles["erp-icon-clr"]}>
                          <FaGlobe />
                        </span>{" "}
                        Web App
                      </h5>
