        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <h3>Best Agricuture Software</h3>
              <p className="my-3">
                Best agricultural software used by farmers are Farmers Edge,
                Agrian, Trimble, Agrivi, and Granular. Such agriculture
                management software helps farmers keep track of the growth of
                their crops, plants, their nutritional value, their lifecycle,
                and more.
              </p>
            </Col>
          </Row>
