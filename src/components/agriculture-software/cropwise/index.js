...
import styles from "../cropwise/cropwise.module.scss";
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Cropwise</h3>
                    <h5 className="text-light">DIGITAL FARMING CONNECTED</h5>
