...
import styles from "../fieldmargin/fieldmargin.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">FieldMargin</h3>
                    <h5 className="text-light">Software by Fieldmargin</h5>
