...
import styles from "../produce-inventory/produce-inventory.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href=""> Produce Inventory Control System </Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <h5 className="text-light">Software by WaudWare</h5>
