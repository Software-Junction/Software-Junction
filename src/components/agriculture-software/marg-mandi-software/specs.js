  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Marg Mandi Software Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        Marg House, Plot No. 7, Wazirpur Press Area, Near D.T.C Depot, Opp. Netaji Subhash Place, Delhi - 110035
                      </p>
                    </h5>
                  </Col>
                </Row>
