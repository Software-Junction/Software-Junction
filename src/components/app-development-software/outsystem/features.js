...
const featuresData = [
  ...
  { title: "Low-Code for Developers" },
  { title: "Full Stack Development" },
  { title: "Accelerated App Development" },
  { title: "Process Automation" },
  { title: "Low-Code Integration" },
  { title: "Dev to Deploy" },
  { title: "Customer Apps and Portals" },
  { title: "Internal Business Apps" },
  { title: "Artificial Intelligence" },
  { title: "Global Customer Success Stories" },
  { title: "Application Modernization" },
  { title: "Cross-Industry Solutions" },
  { title: "Core Systems" },
  { title: "Community and Support" },
  { title: "One-Click Deployment" },
  { title: "OutSystems Developer Conference" },
  { title: "Forrester Wave and Gartner Recognition" },
