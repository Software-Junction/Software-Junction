...
import styles from "../brainvire-infotech/brainvire-infotech.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/app-development-software">
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Brainvire Infotech</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Brainvire Infotech</h3>
                    <h5 className="text-light">
                      Software by Brainvire Infotech Inc
                    </h5>
