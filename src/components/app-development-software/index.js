        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <p className="my-3">
                Best App development software are Swing2App, Alpha Anywhere,
                Scriptcase, Visual Studio, Xcode, and OutSystems. such app
                development tools make it easy to build their app.
              </p>
            </Col>
          </Row>
        </Container>
