  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">DronaHQ Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        Deltecs Infotech Pvt. Ltd. A-309 Crystal Plaza, New Link
                        Road Andheri (W), Mumbai 400053 India{" "}
                      </p>
                    </h5>
                  </Col>
                </Row>
