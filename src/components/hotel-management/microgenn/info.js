  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={7}>
            <h3>What is Microgenn ?</h3>
            <p>
              Microgenn offers specialized Hotel Management Software, providing
              tailored solutions for the hospitality industry. With 11 years of
              experience and a portfolio of 19 products, Microgenn ensures
              reduced complexity, pocket-friendly solutions, and user-friendly
              interfaces. From front office and point of sale to bar management
              and housekeeping, their comprehensive IT services empower
              businesses with all-encompassing support, earning them 13 awards
              and the trust of 292 happy clients. Elevate your business success
              with Microgenn's excellent IT solutions for the hotel industry.
            </p>
           {/* <div
