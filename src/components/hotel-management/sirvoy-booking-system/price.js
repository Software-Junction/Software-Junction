  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-3">Sirvoy Booking System Pricing</h3>
          </Col>
          <Col lg={3} className="mb-3">
            ...
            >
              ...
              <ul className={styles["price-btn"]}>
                ...
                <li>Trip Advisor Instant Booking/Review Express</li>
              </ul>
              <div className="text-center">
          ...
          <Col lg={3} className="mb-3">
            ...
            >
              ...
              <hr />
              <ul className={styles["price-btn"]}>
                <li>All features in Starter</li>
                <li>Multiple user permissions</li>
                <li>Multiple booking engines</li>
