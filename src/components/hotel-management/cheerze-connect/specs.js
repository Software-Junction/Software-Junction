    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
            Cheerze Connect Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Fourth Dimension Software Systems Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Fourth Dimension Software Systems India Pvt Ltd. Bali Towers, 5th Floor, 1, Abdul Razack Street Anna Salai, Saidapet Chennai 600 015 India
                      </p>
                    </h5>
                  </Col>
                </Row>
