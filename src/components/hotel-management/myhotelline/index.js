...
import styles from "../myhotelline/hotel.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">MyHotelLine</h3>
                    <h5 className="text-light">Serving Hospitality</h5>
