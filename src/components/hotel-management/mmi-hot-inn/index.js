...
import styles from "../mmi-hot-inn/mmi.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="">MMI HOT inn - Hotel Software</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">MMI HOT inn - Hotel Software</h3>
                    <h5 className="text-light">MOST RELIABLE E-MANAGER</h5>
