    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
            Ecogreen Express Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : C-Square Info-Solutions Ltd
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      IBC Knowledge Park, Tower A, 6 th Floor , 4/1, Bannerghatta Main Rd, Bhavani Nagar, S.G. Palya, Bengaluru, Karnataka 560029
                      </p>
                    </h5>
                  </Col>
                </Row>
