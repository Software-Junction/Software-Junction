...
import styles from "../halemind/hale.module.scss";
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Halemind</h3>
                    <h5 className="text-light">Best Medical Store Software</h5>
