...
import styles from "../visual/vis.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/medical-store">Medical Store Software</Link>
                  </li>
                  &nbsp;
                  <span style={{ color: "#f95738 " }}>
                    <MdKeyboardDoubleArrowRight />
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Visual Chemist Store</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Visual Chemist Store</h3>
                    <h5 className="text-light">
                      Best Electronic Medical Records Software in India
                    </h5>
