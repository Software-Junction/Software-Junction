  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">CREST ERP Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Xmplar Management Solutions Private Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Xmplar Management Solutions #760, 2nd Floor, 19th Main, HSR Layout, Sector II, Bangalore 560102 India
                      </p>
                    </h5>
                  </Col>
                </Row>
