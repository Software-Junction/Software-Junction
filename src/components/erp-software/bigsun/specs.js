  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">BIGSUN Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
              ...
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5>Onetime(Perpetual license), Transaction</h5>
                  </Col>
                  <Col lg={3} className="mb-3">
                    <h5>Accessibility :</h5>
                  </Col>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Bigsun Technologies Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      B-406,Technocity, Plot No.X-4/1,4/2,MIDC, TTC, Mahape, Navi Mumbai - 400710
                      </p>
                    </h5>
                  </Col>
                </Row>
