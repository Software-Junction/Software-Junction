...
import styles from "../infor-cloudsuite/infor.module.scss";
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/erp-software">ERP Software</Link>
                  </li>
                  &nbsp;
                  <span style={{ color: "#f95738 " }}>
                    <MdKeyboardDoubleArrowRight />
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Infor CloudSuite™ ERP</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Infor CloudSuite™ ERP</h3>
