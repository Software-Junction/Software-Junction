        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <p className="my-3">
                Best ERP software in India are Oracle NetSuite, Microsoft
                Dynamics, SAP ERP, TallyPrime, Vyapar, and Infor. ERP systems
                manage and simplify day-to-day business operations like
                financials, procurement, supply chain, manufacturing, and more.
              </p>
            </Col>
          </Row>
        </Container>
