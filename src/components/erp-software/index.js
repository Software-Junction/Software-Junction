    ...
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="">ERP Software</Link>
                  </li>
                </ul>
              </div>
              <h3>Best ERP Software System</h3>
              <p className="my-3">
                Discover the best ERP software of 2024, reviewed for features,
                user satisfaction, and performance. This guide provides
                comprehensive insights into top solutions for integrating
                business processes, managing resources, and enhancing
                efficiency. Our expert analysis and comparison metrics help you
                select the ideal software for your enterprise's needs. Stay
                ahead with the most advanced and reliable ERP software
                available. Explore now to find the perfect solution for
                optimizing your organization's operations and growth.
              </p>
            </Col>
          </Row>
        </Container>
      ...
      <section className={styles["headbg-2"]}>
        <Container>
          <Row>
            <Col lg={12}>
              <h3>Top 10 ERP Software</h3>
              <p>
                Explore the top 10 ERP Software solutions offering
