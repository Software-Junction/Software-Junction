                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : QuickBill Solutions Private Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      R.T. SQUARE, 579/B, Outer Ring Rd, Near Bank of India, Sector 6, HSR Layout, Bengaluru, Karnataka 560102
                      </p>
                    </h5>
                  </Col>
                </Row>
