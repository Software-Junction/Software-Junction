                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : ZipBooks Software Solutions Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      201, Abhishree Avenue, Opp. Hanumanji Temple, Nehrunagar, Ambawadi, Ahmedabad - 380015, Gujarat, India.
                      </p>
                    </h5>
                  </Col>
                </Row>
