  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">CaptainBiz Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        Plot No 34, 35, 38, Vishwaroop Infotech Pvt. Ltd, LOGO
                        INFOSOFT BUSINESS TECHNOLOGY PVT. LTD Second Floor,
                        Raghu Leela Mall Arcade, next to Mc Donald’s, Vashi,
