...
import styles from "../amrita-his/amr.module.scss";
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Amrita Hospital Information System</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Amrita Hospital Information System</h3>
