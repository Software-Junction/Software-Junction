  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">GeniPulse Hospital Management Software Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : GeniPulse Technologies
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      GeniPulse A/215, Office 65,IIIrd Floor Chawla Complex, Delhi-110092 India
                      </p>
                    </h5>
                  </Col>
                </Row>
