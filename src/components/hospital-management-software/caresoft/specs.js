  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Caresoft Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : CARESOFT CONSULTANCY PVT. LTD.
                    </h5>
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      311, 2nd Floor, Mahesh Industrial Estate, Silver Park, Mira Road East, Thane
                      </p>
                    </h5>
                  </Col>
                </Row>
