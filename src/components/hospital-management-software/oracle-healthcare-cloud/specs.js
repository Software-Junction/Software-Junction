  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Oracle Healthcare Cloud Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Oracle Corporation 500 Oracle Parkway, M/S 5op7 Redwood Shores, CA 94065 USA
                      </p>
                    </h5>
                  </Col>
                </Row>
