  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Suvarna Technosoft's Hospital Information Management System Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Suvarna Technosoft Pvt Ltd
                    </h5>
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Suvarna Technosoft Pvt. Ltd. , 6-3-191/C/1, 4th Floor, Fortune 9,Raj Bhavan Road, Somajiguda,
                      </p>
                    </h5>
                  </Col>
                </Row>
