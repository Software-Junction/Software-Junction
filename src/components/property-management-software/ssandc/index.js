...
import styles from "../ssandc/ssandc.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">SS&C SKYLINE</h3>
                    <h5 className="text-light">
                      Leading PMS software for real estate firms{" "}
                    </h5>
