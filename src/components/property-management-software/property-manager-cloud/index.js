...
import styles from "../property-manager-cloud/property-manager-cloud.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="/property-management-software">
                  ...
                  &nbsp;
                  <li>
                    <Link href="">Property Manager Cloud</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  <Image
                    ...
                    alt="property-management-cloud"
                    width="200"
                    height="10"
                    className={`${styles["box-img"]} border bg-light p-4 rounded-3 shadow me-4`}
                  />
                  <div>
                    <h3 className="text-light">Property Manager Cloud</h3>
                    <h5 className="text-light">
                      A simple and efficient PMS software{" "}
                    </h5>
