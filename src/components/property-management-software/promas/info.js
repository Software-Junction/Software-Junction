  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={7}>
            <h3>What is PROMOS ?</h3>
            <p>
              PROMAS is a robust property management software with over 30 years
              of industry expertise, catering to property managers and homeowner
              associations. Whether in the cloud or on-site, it offers powerful
              reporting and rock-solid accounting features. The software's focus
              on management allows users to efficiently run their businesses
              without extensive accounting experience. With login access
              providing updates, support, documents, tutorials, and webinars,
              PROMAS ensures a seamless experience for users. Developed by Think
              Up Themes Ltd. and powered by WordPress, it stands out as a
              trusted solution for effective business operations in the real
