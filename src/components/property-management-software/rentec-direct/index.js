...
import styles from "../rentec-direct/rentec-direct.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Rentec Direct</h3>
                    <h5 className="text-light">
                      Top-rated property management system software
                    </h5>
