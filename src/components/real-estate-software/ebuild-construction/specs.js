  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">eBuild Construction Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : eBuild Softwares and Solutions Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    {/* <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      "Yashashri" Apartments, Lane No. 3, Bhandarkar Road, Deccan Gymkhana, Pune - 411 004
                      </p>
                    </h5> */}
                  </Col>
                </Row>
