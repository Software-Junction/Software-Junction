  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Banibro Solutions Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Banibro IT Solutions Private Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        54/8, 54/9, Paul Wells Rd, Sripuram Colony, Viralur,
                        Gandhi Nagar, St.Thomas Mount, Ramapuram, Tamil Nadu
                        600016.{" "}
                      </p>
                    </h5>
                  </Col>
