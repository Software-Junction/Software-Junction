...
import styles from "../4qt/4qt.module.scss";
const Index = () => {
  return (
    <>
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="">4QT Real Estate ERP</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">4QT Real Estate ERP</h3>
                    <h5 className="text-light">
                      Software by 4th Quarter Technologies{" "}
                    </h5>
