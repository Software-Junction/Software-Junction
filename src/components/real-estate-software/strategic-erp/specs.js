  ...
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Strategic ERP Specifications</h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : ITAakash Strategic Software (p) Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                        5th floor, D S Business Galleria, Near Huma Adlabs,
                        Beside Toyo House, L.B.S. Road, Kanjur Marg (W), Mumbai,
                        400078 INDIA.
                      </p>
                    </h5>
                  </Col>
