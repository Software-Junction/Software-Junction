...
import styles from "../sas-analytic-pro/sas.module.scss";
            ...
            <Col lg={12}>
              <div className={`${styles["breadcr"]} `}>
                <ul>
                  ...
                  &nbsp;
                  <li>
                    <Link href="">SAS Analytics Pro</Link>
                  </li>
                </ul>
              </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">SAS Analytics Pro</h3>
                    <h5 className="text-light">Tools by SAS Institute Inc.</h5>
