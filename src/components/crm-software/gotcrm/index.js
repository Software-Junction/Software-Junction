...
import styles from '../gotcrm/got.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">GOT CRM</h3>
                    <h5 className="text-light">Reach your sales target with Got CRM</h5>
