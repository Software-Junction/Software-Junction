...
import styles from '../opd-plus/opd.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#FC5185 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">OPD PLUS Management Software</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">OPD PLUS Management Software</h3>
                    <h5 className="text-light">Clinic Management Software</h5>
                    <p
