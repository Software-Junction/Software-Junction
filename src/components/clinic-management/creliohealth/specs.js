                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Creliant Software Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Baner Biz Bay, S No. 110/11/23 Behind Techlead Bus Stop Near D-Mart, Laxman Nagar, Baner, Pune, Maharashtra 411045
                      </p>
                    </h5>
                  </Col>
                </Row>
