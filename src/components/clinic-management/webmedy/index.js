...
import styles from '../webmedy/web.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Webmedy</h3>
                    <h5 className="text-light">Software by Ardinia Systems Pvt Ltd</h5>
                    <p
