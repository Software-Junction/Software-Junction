...
import styles from '../clinisys/sys.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Clinisys</h3>
                    <h5 className="text-light">Software by Bio Analytical Technologies</h5>
                    <p
