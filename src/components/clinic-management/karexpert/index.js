            ...
            <div className={`${styles['breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#FC5185 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">KareXpert's EMR/EHR Software</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">KareXpert's EMR/EHR Software</h3>
                    <h5 className="text-light">More Time Caring. Less Time Charting.</h5>
                    <p
