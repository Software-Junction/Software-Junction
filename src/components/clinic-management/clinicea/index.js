...
import styles from '../clinicea/clini.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
              ...
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Clinicea</h3>
                    <h5 className="text-light">Software by Clinicea</h5>
                    <p
