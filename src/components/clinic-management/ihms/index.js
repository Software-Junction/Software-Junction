            ...
            <div className={`${styles['breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#FC5185 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">The iHMS (Hospital Management System)</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">The iHMS (Hospital Management System)</h3>
                    <h5 className="text-light">Software by TECHQUEST SERVICES</h5>
                    <p
