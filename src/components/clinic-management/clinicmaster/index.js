...
import styles from '../clinicmaster/clinic.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#FC5185 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">Clinicmaster</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Clinicmaster</h3>
                    <h5 className="text-light">Software by Vimukti Technologies Pvt. Ltd.</h5>
                    <p
