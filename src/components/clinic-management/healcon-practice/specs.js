    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
            Healcon Practice Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
                ...
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Healcon Labs Pvt. Ltd.
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["icon-clr"]}>
                        <BsBuildingsFill />
                    ...
                    {/* <h5 className="mb-3">
                      ...
                      Full Address :{" "}
                      <p className="mt-2">
                      Estancia IT Park, Plot no. 140, 151, GST Road, Vallancheri, Chengalpattu District, Tamil Nadu - 603202
                      </p>
                    </h5> */}
                  </Col>
                </Row>
