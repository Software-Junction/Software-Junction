...
import HealconP from "../clinic-management/healcon-practice/price";

import PractoF from "../clinic-management/practo-ray/features";
import PractoU from "../clinic-management/practo-ray/usp";

import ClinsavF from "../clinic-management/clinsav/features";
import ClinsavU from "../clinic-management/clinsav/usp";
import ClinsavP from "../clinic-management/clinsav/price";

import DocengageF from "../clinic-management/docengage/features";
import DocengageU from "../clinic-management/docengage/usp";

import CrelioF from "../clinic-management/creliohealth/features";
import CrelioU from "../clinic-management/creliohealth/usp";
import CrelioP from "../clinic-management/creliohealth/price";

import WebmedyF from "../clinic-management/webmedy/features";
import WebmedyU from "../clinic-management/webmedy/usp";
import WebmedyP from "../clinic-management/webmedy/price";

import QmarkF from "../clinic-management/qmarksoft/features";
import QmarkU from "../clinic-management/qmarksoft/usp";

import ClinicF from "../clinic-management/clinicmaster/features";
import ClinicU from "../clinic-management/clinicmaster/usp";
...
import LybrateP from "../clinic-management/lybrate/price";
                    ...
                    <tr>
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Comprehensive Clinic Management</p>
                          <p>Reduced No Shows</p>
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Ayushman Bharat Digital Mission Compliance</p>
                          <p>User Base and Global Reach</p>
                          <p>Reducing No-Shows and Improving Efficiency</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "10px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Ultimate Security and Control</p>
                          <p>Seamless Patient Management</p>
                          <p>Flexible Appointment Tracking</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "10px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          ...
                          <p>Seamless Website Integration</p>
                          <p>Personalized Promotions and Targeted Packages</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "10px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>Practice Management</p>
                          <p>Flexible and Intuitive Charting</p>
                          <p>Insightful Clinical Reports</p>
                        </div>
                        <Button
                          size="sm"
                          style={{ fontSize: "10px" }}
                      ...
                      <td>
                        <div className={styles["clm-height"]}>
                          <p>No Installation Hassle</p>
                          <p>Security and Data Safety</p>
