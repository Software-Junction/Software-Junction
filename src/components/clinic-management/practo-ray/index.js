...
import styles from '../practo-ray/prac.module.scss'
const Index = () => {
  return (
    <>
            ...
            <div className={`${styles['breadcr']} `}>
                <ul>
                 <li> <Link href="/#">Home</Link></li>&nbsp;<span style={{color : '#FC5185 '}}><MdKeyboardDoubleArrowRight /></span>&nbsp;
                  ...
                  <li><Link href="">Practo Ray</Link></li>
                </ul>
             </div>
              <div>
                <div className="d-flex">
                  ...
                  />
                  <div>
                    <h3 className="text-light">Practo Ray</h3>
                    <h5 className="text-light">Software by Practo Technologies Private Limited</h5>
                    <p
