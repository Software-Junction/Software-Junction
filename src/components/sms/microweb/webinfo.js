        ...
        <Row>
          <Col lg={6}>
            ...
            <p>
              ...
              user-friendly, web-based software for modern schools. This ERP
            ...
            <div
              className={`${styles["web-priceplan-box"]} box bg-light  rounded-4 p-3 mb-4 border`}
            >
              <h5>Pricing Plans :</h5>
              <p>
