...
const Jupreview = ({ styles }) => {
  return (
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">Jupsoft eConnect User Reviews</h3>
          </Col>
          <Col lg={10}>
            <div
              className={`${styles["jup-main-box-mob"]} box  bg-light rounded-4 p-4  mb-4 border`}
            >
              <div
                className={`${styles["jup-box-mob"]} box border  text-center rounded-2 p-4`}
              >
                <div className={styles["jup-box-rating"]}>
                  <div>
                    <p>Overall Score</p>
                    <h5>
                      4.3<small>/5</small>
        ...
        <Row>
        <Col lg={12} >
        <div  className={`${styles["jup-row-mob"]} box bg-light  border  rounded-4 p-4`}>
        <Row>
        ...
        <Row>
      <Col lg={12} >
        <div  className={`${styles["jup-row-mob"]} box bg-light mt-4 border  rounded-4 p-4`}>
        <Row>
          <Col lg={3}>
            <Image src="/images/user.png" alt="user" width="60" height="10" />
            <h5 className="my-3">Kristen</h5>
