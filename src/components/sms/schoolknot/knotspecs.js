    ...
    <>
      <Container>
        <Row>
          <Col lg={12}>
            <h3 className="mb-4">
              SchoolKnot Specifications
            </h3>
          </Col>
          <Row>
            <Col lg={12}>
              <div
                className={`${styles["knt-soft-specs"]} border bg-light rounded-4 p-4`}
              >
                <Row>
                  ...
                  <Col lg={9} className="mb-3">
                    <div className={`${styles["knt-spec-mob"]} d-flex`}>
                    
                    <h5 className="me-3">
                        <span className={styles["knt-icon-clr"]}>
                          <IoLogoWindows />
                        </span>{" "}
                        Windows
                      </h5>
                  ...
                  <Col lg={9} className="mb-3">
                    <h5 className="mb-3">
                      ...
                      Company Name : Knoty Labs Private Limited
                    </h5>
                    <h5 className="mb-3">
                      <span className={styles["knt-icon-clr"]}>
                        <BsBuildingsFill />
