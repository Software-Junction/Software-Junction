    ...
    <>
        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <p className="my-3">
                Discover the best school management software of 2024, thoroughly
                evaluated for functionality, user satisfaction, and feature set.
                This guide provides comprehensive insights into leading
                solutions for enhancing academic administration, streamlining
                communication, and improving overall efficiency. Our expert
                reviews and comparison metrics ensure you select the ideal
                software for your school's needs. Stay ahead with the most
                effective and reliable school management software available.
                Explore now to find the perfect solution for your institution.
              </p>
            </Col>
          </Row>
        </Container>
      ...
      <section className={styles['headbg-2']}>
        <Container>
          <Row>
            <Col lg={12}>
            <h3>Top 10 School Management Software</h3>
              <p>
                Explore the top 10 School Management Software solutions offering comprehensive
