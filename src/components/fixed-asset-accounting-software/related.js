      ...
      <section className={`${styles['related-categories']} mt-5 pb-5`}>
        <Container>
            <Row>
                ...
                <Button variant="outline-primary" className={`${styles['cat-btn1']} mt-3`}>OMR Software</Button>
                <Button variant="outline-primary" className={`${styles['cat-btn1']} ms-4 mt-3`}>Online Exam Software</Button>
                ...
                <Button variant="outline-primary" className={`${styles['cat-btn1']} mt-3`}>Virtual Classroom Software</Button>
                <Button variant="outline-primary" className={`${styles['cat-btn1']} ms-4 mt-3`}>Child Care Management Software</Button>
