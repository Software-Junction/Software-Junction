        ...
        <Container>
          <Row>
            <Col lg={12}>
              ...
              <p className="my-3">
                Best fixed asset accounting software includes Maxpanda CMMS,
                EAMbrace Asset Management, and Asset Express. Such fixed asset
                accounting tools are used to automate the process of asset
                tracking and better productivity.
              </p>
            </Col>
          </Row>
        </Container>
